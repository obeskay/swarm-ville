      ...
      <div className={`relative ${className}`}>
        <AnimatePresence>
          {isLevelingUp && (
            ...
            >
              <div className="bg-gradient-to-r from-primary via-primary/90 to-primary text-primary-foreground px-6 py-3 rounded-full shadow-elevated font-bold text-lg flex items-center gap-2">
    ...
    <div className={`relative ${className}`}>
      <AnimatePresence>
        {isLevelingUp && (
          ...
          >
            <div className="bg-gradient-to-r from-primary via-primary/90 to-primary text-primary-foreground px-8 py-4 rounded-2xl shadow-elevated">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center text-primary-foreground shadow-soft">
                <div className="text-center">
