      ...
      >
        ...
        {activeMissions.length === 0 ? (
          <div
            style={{
              textAlign: "center",
              color: theme.colors.text.dark.tertiary,
              fontSize: "13px",
              padding: "24px 0",
            }}
          >
          ...
          <div
            style={{
              ...
              gap: `${missionsConfig.itemMarginBottom}px`,
            }}
          >
            {activeMissions.map((mission) => (
              ...
              >
                ...
                >
                  <div
                    style={{ fontWeight: 600, fontSize: "13px", color: missionsConfig.titleColor }}
                  >
                    {mission.title}
                  </div>
                  <Badge
                    style={{
                      fontSize: "11px",
                      backgroundColor: missionsConfig.rewardBadgeBackgroundColor,
                      color: missionsConfig.rewardBadgeTextColor,
                    }}
                  >
                    +{mission.xpReward} XP
                  </Badge>
                ...
                <div
                  style={{
                    fontSize: "12px",
                    color: missionsConfig.descriptionColor,
                    marginBottom: "8px",
                  }}
                >
                  {mission.description}
