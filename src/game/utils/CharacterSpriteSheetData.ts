// Character spritesheet data structure
// Format: 192x192 total, 4x4 grid (48x48 per frame)
// Rows: walk_down (y:0), walk_left (y:48), walk_right (y:96), walk_up (y:144)
// Columns: frame 0 (x:0), frame 1 (x:48), frame 2 (x:96), frame 3 (x:144)

const characterSpriteSheetData = {
  frames: {
    walk_down_0: {
...
export default characterSpriteSheetData
